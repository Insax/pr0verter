                    ...
                    <div class="slider">
                        <form action="{{route('convert')}}" method="POST" id="form" enctype="multipart/form-data">
                            ...
                            <div class="slider-form slider-start">
                                <h2>Willkommen beim pr0verter, hier kannst du Videos für das pr0 hochladen und
                                    konvertieren lassen!</h2>
                                <button class="start next"><span class="glyphicon glyphicon-console"></span> Starten
                                </button>
                            </div>
                            <div class="slider-form slider-ul">
                                <h2>Möchtest du ein Video zum pr0verter hochladen oder möchtest du eine URL zu einer
                                    externen Quelle angeben?</h2>
                                <div class="label-ctr">
                                    <label class="radio">
                                ...
                                <button class="ultype next" disabled="disabled">Weiter <span
                            ...
                            <div class="slider-form slider-choose">
                                ...
                                <div id="mydropzone" style="display: none;">
                                    <h2>Hier kannst du das gewünschte Video per drag and drop oder durch draufklicken
                                        auswählen</h2>
                                ...
                                <div id="formurl" class="form-group" style="display: none;">
                                    ...
                                    <input type="text" class="form-control" size=40 name="url" id="urlform"
                                           style="display: none;"/>
                                </div>
                                <div id="youtubeform" class="form-group" style="display: none;">
                                    <h2>Bitte eine URL zu einem Youtubevideo hier angeben!</h2>
                                    <input type="text" class="form-control" size=40 name="youtube" id="youtube"
                                           style="display: none;"/>
                                </div>
                                <button class="choose back"><span class="glyphicon glyphicon-chevron-left"></span>
                                    Zurück
                                </button>
                                <button class="choose next" disabled="disabled">Weiter <span
                                            class="glyphicon glyphicon-chevron-right"></span></button>
                            </div>
                            ...
                            <div class="slider-form slider-size">
                                ...
                                <button class="size back"><span class="glyphicon glyphicon-chevron-left"></span> Zurück
                                </button>
                                <button class="size next">Weiter <span class="glyphicon glyphicon-chevron-right"></span>
                                </button>
                            </div>

                            <div class="slider-form slider-sound">
                                <label for="sound">
                                    Hier kannst du entweder keinen Ton oder die Qualität des Tons festlegen. Bitte
                                    bedenke das eine höhere Tonqualität mehr Speicherplatz verbraucht.
                                </label>
                                <input type="text" id="sound" readonly style="background-color: #161618; border: 0px;">
                                <input type="hidden" id="refsound" name="sound">
                                <div id="slider">
                                </div>
                                <button class="sound back"><span class="glyphicon glyphicon-chevron-left"></span> Zurück
                                </button>
                                <button class="sound next">Weiter <span
                                            class="glyphicon glyphicon-chevron-right"></span></button>
                            </div>
                            <div class="slider-form slider-res">
                                <h2>Hier kannst du festlegen ob du die Origrinalauflösung beibehalten willst oder
                                    nicht.</h2>
                                <div class="label-ctr">
                                ...
                                <button class="res back"><span class="glyphicon glyphicon-chevron-left">Zurück</span>
                                </button>
                                <button class="res next">Weiter <span class="glyphicon glyphicon-chevron-right"></span>
                                </button>
                            </div>
                            <div class="slider-form slider-clip">
                                <h2>Hier kannst du die Zeitstempel für den Schnitt angeben. Angabe in Sekunden.</h2>
                                <input placeholder="Startzeit" type="number" class="form-control" name="cutstart"
                                       id="cutstart"/>
                                <input placeholder="Endzeit" type="number" class="form-control" name="cutend"
                                       id="cutend"/>

                                <button class="clip back"><span class="glyphicon glyphicon-chevron-left">Zurück</span>
                                </button>
    ...
    <div class="container-fluid" id="full">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center" id="progress">
                ...
                <br>
                <div class="progress">
                    <div id="upload_bar" class="progress-bar progress-bar-danger progress-bar-striped active"
