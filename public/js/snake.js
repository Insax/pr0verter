        ...
        me.handleDeath = function() {
            function recordScore () {
                ...
                if (me.snakeLength > highScore) {
                    alert('Gratuliere, du hast deinen bisherigen Highscore: ' + highScore + 'geschlagen!');
    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:10px;'>[Pausiert]<p/>Drück die Leertaste um weiterzuspielen.</div>";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Snake<p></p>Benutze die <strong>Pfeiltasten</strong> auf deiner Tastatur um das Spiel zu spielen. " + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.appendChild(document.createTextNode("Spiel Starten"));
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Snake<p></p>Du bist gestorben.<p></p>";
...
function getHighScore () {
    document.getElementById('high-score').addEventListener('click', function () {
        if (localStorage.jsSnakeHighScore == undefined) alert('Du hast noch nicht gespielt!');
        else
    alert('Dein aktueller Highscore ist bei ' + localStorage.jsSnakeHighScore + '.'); });
}
getHighScore();
